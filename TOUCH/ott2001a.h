...
//IO操作函数	 
#define OTT_RST_L	HAL_GPIO_WritePin(GPIOB,GPIO_PIN_14,GPIO_PIN_RESET)
#define OTT_RST_H 	HAL_GPIO_WritePin(GPIOB,GPIO_PIN_14,GPIO_PIN_SET)
